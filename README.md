...
# Содержание 
 1. Установка
 1.2. Интеграционные бойлерплейты
 1.2.1. Биндинги типов в интеграциях
 2. Кратко об Entity-Component-System.
 2.1. Думай Компонентами, а не свойствами!
 2.2. Логика никак не связана с объектами!
 2.3. Секрет гибкости оказывается прост.
 3. Как устроен Cramp Framework.
 3.1 Компоненты в Cramp.
 3.1.1. Пример создания Компонента в Cramp.
 3.1.2. Компоненты-тэги в Cramp.
 3.1.3. Хорошие практики при работе с Компонентами.
 3.2. Сущности в Cramp.
 3.2.1. Пример создания Сущности в Cramp.
 3.2.2. Кэширование Компонентов в Сущности.
 3.2.3. Доступ к Ноде игрового движка.
 3.2.4. Фабрики Сущностей.
 3.2.5. Хорошие практики при работе с Сущностями.
 3.3. Хранилища Сущностей
 3.3.1. Пример использования Хранилища Сущностей.
 3.3.2. Создание Хранилищ через Фабрики.
 3.3.3. Комбинирование Хранилищ.
 3.3.4. Хорошие практики при работе с Хранилищами.
 3.4. Системы в Cramp.
 3.4.1. Пример создания Системы в Cramp.
 3.4.2. Объект фильтрации Компонентов.
 3.4.3. Хорошие практики при работе с Системами в Cramp.
 3.5. Контейнеры Систем.
 3.5.1. Пример создания и запуска Контейнера.
 3.5.2. Декораторы Систем.
 3.5.3. Декораторы фильтра.
 3.5.4. Отложенный запуск Систем.
 3.5.5. Хорошие практики при работе с Контейнерами.
 3.6. Реакция на изменение Компонентов.
 3.6.1. Хорошие практики при работе с Реакциями на изменения Компонентов.
 3.7. Модули Cramp.
 3.8. Контроль состояния Компонентов.
 4. Так как же это все работает.
 4.1. Простой пример.
 4.2. Более подробные примеры.
