...
Для того, чтобы без проблем переносить некоторые Компоненты, Сущности и Системы между проектами и окружениями, рекомендуется прописать биндинги типов. Пример реализации биндингов можно увидеть в одном из официальных интеграционных шаблонов в файле bindings.types.ts. 
